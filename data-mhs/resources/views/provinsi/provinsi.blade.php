                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="pull-right">
                            <a href="{{ url ('provinsi/add')}}" class="btn btn-success btn-sm">
                                ...
                                @foreach ($provinsis as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('provinsi/edit/'.$item->id) }}" class="btn btn-warning">Edit</a>
                                            <form action="{{ url('provinsi/'.$item->id) }}" method="POST" class="d-inline">
                                                @method('DELETE')
                                                @csrf
