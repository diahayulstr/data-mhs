            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="pull-left">
                            <strong>Edit Provinsi</strong>
                        </div>
                        <div class="pull-right">
                            <a href="{{ url('provinsi') }}" class="btn btn-success btn-sm">
                                Back
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ url('provinsi/'.$provinsi->id) }}" method="POST" enctype="multipart/form-data">
                                    @method('PATCH')
                                    @csrf
                                    <div class="form-group">
                                        <label for="formGroupExampleInput">Nama Provinsi</label>
                                        <input type="text" class="form-control" @error('nama_provinsi') is-invalid @enderror id="nama_provinsi"
                                            name="nama_provinsi" value="{{ old('nama_provinsi') ?? $provinsi->nama_provinsi }}">
                                        @error('nama_provinsi')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <a href="{{ url('provinsi')}}" class="btn btn-danger">Batal</a>
